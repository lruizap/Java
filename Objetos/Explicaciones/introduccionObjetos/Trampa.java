package Objetos.Explicaciones.introduccionObjetos;
...
public class Trampa {
	...
	public String toString() {
		return "Trampa [nombre=" + nombre + ", tipo=" + tipo + ", danio=" + danio + ", capacidad=" + capacidad + ", recargable=" + recargable + ", activa=" + activa + ", nivel=" + nivel + "]";
	}
